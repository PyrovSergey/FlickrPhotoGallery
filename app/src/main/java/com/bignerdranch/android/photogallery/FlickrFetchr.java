...
public class FlickrFetchr {
  ...
  private static final String API_KEY = "b5b12ac4cb833aac7e7e5268027c0ac3";
  ...
  private List<GalleryItem> downloadGalleryItems(String url) {
    ...
    try {
      ...
      // https://api.flickr.com/services/rest/?method=flickr.photos.getRecent&api_key=b5b12ac4cb833aac7e7e5268027c0ac3&format=json&nojsoncallback=1
